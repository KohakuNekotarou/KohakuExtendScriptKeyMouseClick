...
#ifndef __KESKMCScriptingDefs_h__
#define __KESKMCScriptingDefs_h__
...
// Method IDs
enum KESKMCScriptEvents
{
	e_KESKMCClickLeftMouseButton = 'KCLM'
};

#endif // __KESKMCScriptingDefs_h__
